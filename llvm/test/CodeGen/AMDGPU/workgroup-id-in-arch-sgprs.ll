...
; GFX1250-GISEL-NEXT:    s_add_co_u32 s2, s2, 1
...
; GFX1250-GISEL-NEXT:    s_add_co_u32 s2, s3, s2
; GFX1250-GISEL-NEXT:    s_cmp_eq_u32 s4, 0
; GFX1250-GISEL-NEXT:    s_cselect_b32 s2, ttmp9, s2
...
; GFX1250-GISEL-NEXT:    s_wait_xcnt 0x0
; GFX1250-GISEL-NEXT:    s_add_co_u32 s4, s6, 1
; GFX1250-GISEL-NEXT:    s_and_b32 s5, ttmp6, 15
; GFX1250-GISEL-NEXT:    s_mul_i32 s4, ttmp9, s4
; GFX1250-GISEL-NEXT:    s_getreg_b32 s6, hwreg(HW_REG_IB_STS2, 6, 4)
; GFX1250-GISEL-NEXT:    s_add_co_u32 s4, s5, s4
...
; GFX1250-GISEL-NEXT:    s_add_co_u32 s5, s5, 1
; GFX1250-GISEL-NEXT:    s_bfe_u32 s8, ttmp6, 0x40004
; GFX1250-GISEL-NEXT:    s_mul_i32 s5, s7, s5
; GFX1250-GISEL-NEXT:    v_mov_b32_e32 v0, s4
; GFX1250-GISEL-NEXT:    s_add_co_u32 s5, s8, s5
; GFX1250-GISEL-NEXT:    s_cmp_eq_u32 s6, 0
; GFX1250-GISEL-NEXT:    s_cselect_b32 s4, s7, s5
; GFX1250-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX1250-SDAG-NEXT:    s_clause 0x1
; GFX1250-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0 nv
; GFX1250-SDAG-NEXT:    s_load_b64 s[6:7], s[4:5], 0x10 nv
; GFX1250-SDAG-NEXT:    s_wait_xcnt 0x0
...
; GFX1250-GISEL-NEXT:    s_clause 0x1
; GFX1250-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0 nv
; GFX1250-GISEL-NEXT:    s_load_b64 s[6:7], s[4:5], 0x10 nv
; GFX1250-GISEL-NEXT:    s_wait_xcnt 0x0
; GFX1250-GISEL-NEXT:    s_add_co_u32 s4, s11, s12
; GFX1250-GISEL-NEXT:    s_cmp_eq_u32 s8, 0
; GFX1250-GISEL-NEXT:    v_mov_b32_e32 v0, s9
; GFX1250-GISEL-NEXT:    s_cselect_b32 s4, s10, s4
...
; GFX1250-GISEL-NEXT:    s_add_co_u32 s5, s11, s5
; GFX1250-GISEL-NEXT:    s_cmp_eq_u32 s8, 0
; GFX1250-GISEL-NEXT:    s_cselect_b32 s5, s10, s5
