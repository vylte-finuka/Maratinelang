...
; RUN: llc < %s -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx700 | FileCheck %s --check-prefixes=GFX7,GFX7-GI
...
; RUN: llc < %s -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1200 -mattr=+real-true16 -amdgpu-enable-delay-alu=0 | FileCheck %s --check-prefixes=GFX12,GFX12-GI
...
; GFX7-ISEL-LABEL: test_s_signed_i1_f32:
; GFX7-ISEL:       ; %bb.0:
; GFX7-ISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX7-ISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX7-GI-LABEL: test_s_signed_i1_f32:
; GFX7-GI:       ; %bb.0:
; GFX7-GI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX7-GI-NEXT:    s_mov_b32 s5, s4
; GFX7-GI-NEXT:    v_readfirstlane_b32 s7, v1
; GFX7-GI-NEXT:    v_readfirstlane_b32 s6, v0
; GFX7-GI-NEXT:    s_xor_b64 s[6:7], s[6:7], s[4:5]
; GFX7-GI-NEXT:    s_sub_u32 s6, s6, s4
; GFX7-GI-NEXT:    v_mov_b32_e32 v0, 0xdf000000
; GFX7-GI-NEXT:    s_subb_u32 s7, s7, s4
; GFX7-GI-NEXT:    v_cmp_nge_f32_e32 vcc, s16, v0
; GFX7-GI-NEXT:    s_or_b64 s[4:5], vcc, vcc
; GFX7-GI-NEXT:    v_mov_b32_e32 v0, 0x5effffff
; GFX7-GI-NEXT:    s_mov_b32 s4, 0
; GFX7-GI-NEXT:    s_brev_b32 s5, 1
; GFX7-GI-NEXT:    v_cmp_gt_f32_e32 vcc, s16, v0
; GFX7-GI-NEXT:    s_cselect_b64 s[4:5], s[4:5], s[6:7]
; GFX7-GI-NEXT:    s_or_b64 s[6:7], vcc, vcc
; GFX7-GI-NEXT:    s_mov_b32 s6, -1
; GFX7-GI-NEXT:    s_brev_b32 s7, -2
; GFX7-GI-NEXT:    s_cselect_b64 s[4:5], s[6:7], s[4:5]
; GFX7-GI-NEXT:    v_cmp_u_f32_e64 s[6:7], s16, s16
...
; GFX7-ISEL-LABEL: test_s_signed_i1_f64:
; GFX7-ISEL:       ; %bb.0:
; GFX7-ISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX7-ISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX7-GI-LABEL: test_s_signed_i1_f64:
; GFX7-GI:       ; %bb.0:
; GFX7-GI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX12-ISEL-LABEL: test_s_signed_i1_f64:
; GFX12-ISEL:       ; %bb.0:
; GFX12-ISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-ISEL-NEXT:    s_wait_expcnt 0x0
; GFX12-ISEL-NEXT:    s_wait_samplecnt 0x0
...
; GFX12-ISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX12-GI-LABEL: test_s_signed_i1_f64:
; GFX12-GI:       ; %bb.0:
; GFX12-GI-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-GI-NEXT:    s_wait_expcnt 0x0
; GFX12-GI-NEXT:    s_wait_samplecnt 0x0
...
; GFX7-GI-NEXT:    v_cmp_nge_f64_e32 vcc, s[16:17], v[6:7]
; GFX7-GI-NEXT:    v_mul_f64 v[2:3], v[0:1], v[2:3]
; GFX7-GI-NEXT:    v_cmp_u_f64_e64 s[8:9], s[16:17], s[16:17]
; GFX7-GI-NEXT:    s_mov_b32 s6, 0
; GFX7-GI-NEXT:    s_brev_b32 s7, 1
; GFX7-GI-NEXT:    s_mov_b32 s10, -1
; GFX7-GI-NEXT:    s_brev_b32 s11, -2
...
; GFX7-GI-NEXT:    v_cvt_i32_f64_e32 v2, v[2:3]
; GFX7-GI-NEXT:    v_readfirstlane_b32 s13, v2
; GFX7-GI-NEXT:    v_cvt_u32_f64_e32 v0, v[0:1]
; GFX7-GI-NEXT:    v_readfirstlane_b32 s12, v0
; GFX7-GI-NEXT:    s_cselect_b64 s[6:7], s[6:7], s[12:13]
; GFX7-GI-NEXT:    s_or_b64 s[4:5], s[4:5], s[4:5]
; GFX7-GI-NEXT:    s_cselect_b64 s[4:5], s[10:11], s[6:7]
; GFX7-GI-NEXT:    s_or_b64 s[6:7], s[8:9], s[8:9]
; GFX7-GI-NEXT:    s_cselect_b64 s[4:5], 0, s[4:5]
; GFX7-GI-NEXT:    v_mov_b32_e32 v0, s4
; GFX7-GI-NEXT:    v_mov_b32_e32 v1, s5
; GFX7-GI-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-GI-NEXT:    v_readfirstlane_b32 s1, v2
; GFX12-GI-NEXT:    v_readfirstlane_b32 s0, v3
; GFX12-GI-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-GI-NEXT:    s_cselect_b64 s[0:1], s[2:3], s[0:1]
; GFX12-GI-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX12-GI-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-GI-NEXT:    s_cselect_b64 s[0:1], s[4:5], s[0:1]
; GFX12-GI-NEXT:    s_cmp_lg_u32 s6, 0
; GFX12-GI-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX7-ISEL-LABEL: test_s_signed_i1_f16:
; GFX7-ISEL:       ; %bb.0:
; GFX7-ISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX7-ISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX7-GI-LABEL: test_s_signed_i1_f16:
; GFX7-GI:       ; %bb.0:
; GFX7-GI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
