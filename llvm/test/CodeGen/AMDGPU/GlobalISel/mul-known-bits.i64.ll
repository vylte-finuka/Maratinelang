...
; GFX11-NEXT:    global_load_b32 v4, v2, s[4:5]
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    global_load_b32 v4, v1, s[2:3]
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_b32 v4, v0, s[2:3]
; GFX11-NEXT:    global_load_b64 v[0:1], v0, s[4:5]
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_mad_u64_u32 v[2:3], null, v4, v0, 0
; GFX11-NEXT:    v_mul_lo_u32 v0, v4, v1
...
; GFX10-NEXT:    v_mad_u64_u32 v[3:4], s3, v2, v0, 0
; GFX10-NEXT:    v_add_nc_u32_e32 v4, v4, v1
...
; GFX11-NEXT:    v_mad_u64_u32 v[3:4], null, v2, v0, 0
