...
define amdgpu_ps void @test_div_scale(float %arg0, float %arg1) {
  ...
  ; CHECK-NEXT:   [[INT:%[0-9]+]]:_(f32), [[INT1:%[0-9]+]]:_(i1) = G_INTRINSIC intrinsic(@llvm.amdgcn.div.scale), [[COPY]](f32), [[COPY1]](f32), -1
  ; CHECK-NEXT:   [[SEXT:%[0-9]+]]:_(i32) = G_SEXT [[INT1]](i1)
  ; CHECK-NEXT:   G_STORE [[INT]](f32), [[DEF]](p1) :: (store (f32) into `ptr addrspace(1) poison`, addrspace 1)
  ; CHECK-NEXT:   G_STORE [[SEXT]](i32), [[DEF]](p1) :: (store (i32) into `ptr addrspace(1) poison`, addrspace 1)
