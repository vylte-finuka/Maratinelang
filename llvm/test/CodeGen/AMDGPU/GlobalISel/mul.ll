...
; GFX9-NEXT:    s_add_u32 s0, s0, s0
; GFX9-NEXT:    s_add_u32 s1, s1, s1
...
; GFX10PLUS-NEXT:    s_add_u32 s0, s0, s0
; GFX10PLUS-NEXT:    s_add_u32 s1, s1, s1
...
; GFX12-NEXT:    s_add_co_u32 s0, s0, s0
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_add_co_u32 s1, s1, s1
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX1250-NEXT:    s_add_co_u32 s0, s0, s0
; GFX1250-NEXT:    s_add_co_u32 s1, s1, s1
...
; GFX13-NEXT:    s_add_co_u32 s0, s0, s0
; GFX13-NEXT:    s_add_co_u32 s1, s1, s1
...
; GFX10PLUS-NEXT:    s_add_u32 s3, s4, s3
; GFX10PLUS-NEXT:    s_mul_i32 s0, s0, s2
; GFX10PLUS-NEXT:    s_add_u32 s1, s3, s1
; GFX10PLUS-NEXT:    ; return to shader part epilog
;
...
; GFX10PLUS-NEXT:    s_add_u32 s6, s6, s7
...
; GFX12-NEXT:    s_add_co_u32 s6, s6, s7
...
; GFX1250-NEXT:    s_add_co_u32 s6, s6, s7
...
; GFX13-NEXT:    s_add_co_u32 s6, s6, s7
...
; GFX10-NEXT:    v_mul_lo_u32 v1, v7, v4
; GFX10-NEXT:    v_add_nc_u32_e32 v5, v0, v1
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s4, v6, v3, 0
; GFX10-NEXT:    v_add_nc_u32_e32 v2, v5, v2
...
; GFX11-NEXT:    v_mul_lo_u32 v1, v7, v4
; GFX11-NEXT:    v_add_nc_u32_e32 v5, v0, v1
; GFX11-NEXT:    v_mad_u64_u32 v[0:1], null, v6, v3, 0
; GFX11-NEXT:    v_add_nc_u32_e32 v2, v5, v2
...
; GFX12-NEXT:    s_add_co_u32 s1, s1, s2
...
; GFX1250-NEXT:    s_add_co_u32 s1, s1, s2
...
; GFX13-NEXT:    s_add_co_u32 s1, s1, s2
...
; GFX10-NEXT:    v_mul_lo_u32 v4, v11, v4
...
; GFX11-NEXT:    v_mad_u64_u32 v[12:13], null, v9, v5, v[0:1]
; GFX11-NEXT:    v_mad_u64_u32 v[0:1], null, v8, v4, 0
; GFX11-NEXT:    v_mad_u64_u32 v[2:3], null, v10, v4, v[12:13]
; GFX11-NEXT:    v_mad_u64_u32 v[12:13], vcc_lo, v8, v5, v[1:2]
; GFX11-NEXT:    v_mul_lo_u32 v5, v10, v5
; GFX11-NEXT:    v_mad_u64_u32 v[1:2], s0, v9, v4, v[12:13]
; GFX11-NEXT:    v_mul_lo_u32 v4, v11, v4
; GFX11-NEXT:    v_add_co_ci_u32_e64 v3, null, v3, v7, s0
...
; GFX1250-NEXT:    v_dual_mov_b32 v2, v7 :: v_dual_add_nc_u32 v1, v1, v2
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_dual_add_nc_u32 v3, v1, v3 :: v_dual_mov_b32 v1, v6
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
...
; GFX13-NEXT:    v_mul_lo_u32 v4, v11, v4
; GFX13-NEXT:    v_add_co_ci_u32_e64 v3, null, v3, v7, s0
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX13-NEXT:    v_add_co_ci_u32_e64 v3, null, v3, v6, vcc_lo
; GFX13-NEXT:    v_add_nc_u32_e32 v3, v3, v5
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-NEXT:    v_add_nc_u32_e32 v3, v3, v4
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
  %result = mul i128 %num, %den
  ret i128 %result
}
...
; GFX10-NEXT:    v_mul_lo_u32 v8, v22, v8
...
; GFX11-NEXT:    v_mov_b32_e32 v22, v7
; GFX11-NEXT:    v_mad_u64_u32 v[25:26], null, v16, v10, 0
; GFX11-NEXT:    v_mul_lo_u32 v29, v20, v11
; GFX11-NEXT:    v_mul_lo_u32 v30, v19, v12
; GFX11-NEXT:    v_mul_lo_u32 v27, v0, v9
...
; GFX11-NEXT:    v_mad_u64_u32 v[23:24], null, v21, v9, v[3:4]
; GFX11-NEXT:    v_add_co_ci_u32_e64 v3, null, 0, v7, vcc_lo
; GFX11-NEXT:    v_mad_u64_u32 v[4:5], vcc_lo, v20, v8, v[1:2]
; GFX11-NEXT:    v_mad_u64_u32 v[6:7], null, v0, v8, v[23:24]
; GFX11-NEXT:    v_mad_u64_u32 v[0:1], s0, v17, v9, v[25:26]
; GFX11-NEXT:    v_add_co_ci_u32_e64 v25, null, 0, v3, vcc_lo
; GFX11-NEXT:    v_mul_lo_u32 v26, v21, v10
; GFX11-NEXT:    v_mad_u64_u32 v[23:24], vcc_lo, v16, v13, v[5:6]
; GFX11-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s0
; GFX11-NEXT:    v_mad_u64_u32 v[2:3], s0, v18, v8, v[0:1]
; GFX11-NEXT:    v_add_co_ci_u32_e64 v28, null, 0, v5, s0
; GFX11-NEXT:    v_mad_u64_u32 v[0:1], s1, v17, v12, v[23:24]
; GFX11-NEXT:    v_mad_u64_u32 v[5:6], s2, v16, v11, v[3:4]
; GFX11-NEXT:    v_mad_u64_u32 v[3:4], s0, v18, v11, v[0:1]
; GFX11-NEXT:    v_cndmask_b32_e64 v11, 0, 1, s2
; GFX11-NEXT:    v_mad_u64_u32 v[23:24], s2, v17, v10, v[5:6]
; GFX11-NEXT:    v_mad_u64_u32 v[0:1], null, v16, v8, 0
; GFX11-NEXT:    v_add_co_ci_u32_e64 v12, null, 0, v11, s2
; GFX11-NEXT:    v_mad_u64_u32 v[5:6], s3, v19, v10, v[3:4]
; GFX11-NEXT:    v_mad_u64_u32 v[3:4], s2, v18, v9, v[23:24]
...
; GFX11-NEXT:    v_add_co_ci_u32_e64 v1, null, 0, v12, s2
; GFX11-NEXT:    v_mad_u64_u32 v[12:13], s2, v19, v8, v[3:4]
; GFX11-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s5
; GFX11-NEXT:    v_mul_lo_u32 v20, v16, v15
; GFX11-NEXT:    v_mul_lo_u32 v9, v17, v14
; GFX11-NEXT:    v_mad_u64_u32 v[14:15], s5, v21, v8, v[10:11]
; GFX11-NEXT:    v_add_co_ci_u32_e64 v10, null, 0, v1, s2
; GFX11-NEXT:    v_mad_u64_u32 v[1:2], s2, v17, v8, v[5:6]
; GFX11-NEXT:    v_mul_lo_u32 v8, v22, v8
; GFX11-NEXT:    v_add_co_ci_u32_e64 v3, s2, v3, v12, s2
; GFX11-NEXT:    v_add_co_ci_u32_e64 v4, s2, v28, v13, s2
; GFX11-NEXT:    v_add_co_ci_u32_e64 v5, s2, v10, v14, s2
; GFX11-NEXT:    v_add_co_ci_u32_e64 v6, s2, v25, v15, s2
; GFX11-NEXT:    v_add_co_ci_u32_e64 v7, null, v7, v20, s2
; GFX11-NEXT:    v_add_co_ci_u32_e64 v7, null, v7, v9, s5
; GFX11-NEXT:    v_add_co_ci_u32_e64 v7, null, v7, v18, s4
; GFX11-NEXT:    v_add_co_ci_u32_e64 v7, null, v7, v30, s3
; GFX11-NEXT:    v_add_co_ci_u32_e64 v7, null, v7, v29, s0
; GFX11-NEXT:    v_add_co_ci_u32_e64 v7, null, v7, v26, s1
; GFX11-NEXT:    v_add_co_ci_u32_e64 v7, null, v7, v27, vcc_lo
...
; GFX12-NEXT:    v_mul_lo_u32 v8, v22, v8
; GFX12-NEXT:    s_wait_alu depctr_va_sdst(0)
...
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_add_nc_u32_e32 v7, v7, v8
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX1250-NEXT:    v_mul_lo_u32 v2, v7, v8
...
; GFX1250-NEXT:    v_dual_add_nc_u32 v7, v1, v2 :: v_dual_mov_b32 v1, v12
...
; GFX13-NEXT:    v_mul_lo_u32 v8, v22, v8
...
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-NEXT:    v_add_nc_u32_e32 v7, v7, v8
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
  %result = mul i256 %num, %den
  ret i256 %result
}
...
; GFX10-NEXT:    v_mad_u64_u32 v[2:3], s0, 0x50, v4, 0
; GFX10-NEXT:    v_mul_lo_u32 v4, 0x50, v5
; GFX10-NEXT:    v_add_nc_u32_e32 v3, v3, v4
; GFX10-NEXT:    global_store_dwordx2 v[0:1], v[2:3], off
; GFX10-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    v_mad_u64_u32 v[2:3], null, 0x50, v4, 0
; GFX11-NEXT:    v_mul_lo_u32 v4, 0x50, v5
; GFX11-NEXT:    v_add_nc_u32_e32 v3, v3, v4
; GFX11-NEXT:    global_store_b64 v[0:1], v[2:3], off
; GFX11-NEXT:    s_endpgm
;
