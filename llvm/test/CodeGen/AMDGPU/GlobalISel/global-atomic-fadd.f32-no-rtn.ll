...
; RUN: llc -global-isel -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx908 -amdgpu-atomic-optimizer-strategy=DPP -stop-after=instruction-select < %s | FileCheck -check-prefix=GFX908 %s
; RUN: llc -global-isel -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx90a -amdgpu-atomic-optimizer-strategy=DPP -stop-after=instruction-select < %s | FileCheck -check-prefix=GFX90A %s
; RUN: llc -global-isel -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx942 -amdgpu-atomic-optimizer-strategy=DPP -stop-after=instruction-select < %s | FileCheck -check-prefix=GFX942 %s
; RUN: llc -global-isel -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1100 -amdgpu-atomic-optimizer-strategy=DPP -stop-after=instruction-select < %s | FileCheck -check-prefix=GFX11 %s
; RUN: llc -global-isel -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1200 -amdgpu-atomic-optimizer-strategy=DPP -stop-after=instruction-select < %s | FileCheck -check-prefix=GFX11 %s
...
define amdgpu_ps void @global_atomic_fadd_f32_no_rtn_atomicrmw(ptr addrspace(1) %ptr, float %data) {
  ...
  ;
  ; GFX942-LABEL: name: global_atomic_fadd_f32_no_rtn_atomicrmw
  ...
  ; GFX942-NEXT:   GLOBAL_ATOMIC_ADD_F32 [[REG_SEQUENCE]], [[COPY2]], 0, 0, implicit $exec :: (load store syncscope("wavefront") monotonic (f32) on %ir.ptr, addrspace 1)
...
define amdgpu_ps void @global_atomic_fadd_f32_saddr_no_rtn_atomicrmw(ptr addrspace(1) inreg %ptr, float %data) {
  ...
  ; GFX908-NEXT: {{  $}}
  ; GFX908-NEXT:   [[COPY3:%[0-9]+]]:sreg_64_xexec = COPY $exec
  ; GFX908-NEXT:   [[S_AND_B64_:%[0-9]+]]:sreg_64 = S_AND_B64 [[COPY3]], $exec, implicit-def dead $scc
  ; GFX908-NEXT:   [[COPY4:%[0-9]+]]:sreg_32 = COPY [[S_AND_B64_]].sub0
  ; GFX908-NEXT:   [[COPY5:%[0-9]+]]:sreg_32 = COPY [[S_AND_B64_]].sub0
  ; GFX908-NEXT:   [[COPY6:%[0-9]+]]:sreg_32 = COPY [[S_AND_B64_]].sub1
  ...
  ; GFX90A-NEXT:   [[S_AND_B64_:%[0-9]+]]:sreg_64 = S_AND_B64 [[COPY3]], $exec, implicit-def dead $scc
  ; GFX90A-NEXT:   [[COPY4:%[0-9]+]]:sreg_32 = COPY [[S_AND_B64_]].sub0
  ; GFX90A-NEXT:   [[COPY5:%[0-9]+]]:sreg_32 = COPY [[S_AND_B64_]].sub0
  ; GFX90A-NEXT:   [[COPY6:%[0-9]+]]:sreg_32 = COPY [[S_AND_B64_]].sub1
  ...
  ; GFX942-NEXT:   [[S_AND_B64_:%[0-9]+]]:sreg_64 = S_AND_B64 [[COPY3]], $exec, implicit-def dead $scc
  ; GFX942-NEXT:   [[COPY4:%[0-9]+]]:sreg_32 = COPY [[S_AND_B64_]].sub0
  ; GFX942-NEXT:   [[COPY5:%[0-9]+]]:sreg_32 = COPY [[S_AND_B64_]].sub0
  ; GFX942-NEXT:   [[COPY6:%[0-9]+]]:sreg_32 = COPY [[S_AND_B64_]].sub1
  ...
  ; GFX11-NEXT:   [[S_AND_B32_:%[0-9]+]]:sreg_32 = S_AND_B32 [[COPY3]], $exec_lo, implicit-def dead $scc
  ; GFX11-NEXT:   [[S_MOV_B32_:%[0-9]+]]:sreg_32 = S_MOV_B32 0
  ; GFX11-NEXT:   [[COPY4:%[0-9]+]]:vgpr_32 = COPY [[S_AND_B32_]]
