...
define float @v_constained_fadd_f32_fpexcept_strict(float %x, float %y) #0 {
  ...
  ; CHECK-NEXT:   [[STRICT_FADD:%[0-9]+]]:_(f32) = G_STRICT_FADD [[COPY]], [[COPY1]]
  ; CHECK-NEXT:   $vgpr0 = COPY [[STRICT_FADD]](f32)
...
define float @v_constained_fadd_f32_fpexcept_strict_flags(float %x, float %y) #0 {
  ...
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(f32) = COPY $vgpr0
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(f32) = COPY $vgpr1
  ; CHECK-NEXT:   [[STRICT_FADD:%[0-9]+]]:_(f32) = nsz G_STRICT_FADD [[COPY]], [[COPY1]]
  ; CHECK-NEXT:   $vgpr0 = COPY [[STRICT_FADD]](f32)
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
...
define float @v_constained_fadd_f32_fpexcept_ignore(float %x, float %y) #0 {
  ...
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(f32) = COPY $vgpr0
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(f32) = COPY $vgpr1
  ; CHECK-NEXT:   [[STRICT_FADD:%[0-9]+]]:_(f32) = nofpexcept G_STRICT_FADD [[COPY]], [[COPY1]]
  ; CHECK-NEXT:   $vgpr0 = COPY [[STRICT_FADD]](f32)
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
...
define float @v_constained_fadd_f32_fpexcept_ignore_flags(float %x, float %y) #0 {
  ...
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(f32) = COPY $vgpr0
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(f32) = COPY $vgpr1
  ; CHECK-NEXT:   [[STRICT_FADD:%[0-9]+]]:_(f32) = nsz nofpexcept G_STRICT_FADD [[COPY]], [[COPY1]]
  ; CHECK-NEXT:   $vgpr0 = COPY [[STRICT_FADD]](f32)
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
...
define <2 x float> @v_constained_fadd_v2f32_fpexcept_strict(<2 x float> %x, <2 x float> %y) #0 {
  ...
  ; CHECK-NEXT:   [[BUILD_VECTOR1:%[0-9]+]]:_(<2 x f32>) = G_BUILD_VECTOR [[COPY2]](f32), [[COPY3]](f32)
  ; CHECK-NEXT:   [[STRICT_FADD:%[0-9]+]]:_(<2 x f32>) = G_STRICT_FADD [[BUILD_VECTOR]], [[BUILD_VECTOR1]]
  ; CHECK-NEXT:   [[UV:%[0-9]+]]:_(f32), [[UV1:%[0-9]+]]:_(f32) = G_UNMERGE_VALUES [[STRICT_FADD]](<2 x f32>)
...
define <2 x float> @v_constained_fadd_v2f32_fpexcept_ignore(<2 x float> %x, <2 x float> %y) #0 {
  ...
  ; CHECK-NEXT:   [[COPY3:%[0-9]+]]:_(f32) = COPY $vgpr3
  ; CHECK-NEXT:   [[BUILD_VECTOR1:%[0-9]+]]:_(<2 x f32>) = G_BUILD_VECTOR [[COPY2]](f32), [[COPY3]](f32)
  ; CHECK-NEXT:   [[STRICT_FADD:%[0-9]+]]:_(<2 x f32>) = nofpexcept G_STRICT_FADD [[BUILD_VECTOR]], [[BUILD_VECTOR1]]
  ; CHECK-NEXT:   [[UV:%[0-9]+]]:_(f32), [[UV1:%[0-9]+]]:_(f32) = G_UNMERGE_VALUES [[STRICT_FADD]](<2 x f32>)
  ; CHECK-NEXT:   $vgpr0 = COPY [[UV]](f32)
  ; CHECK-NEXT:   $vgpr1 = COPY [[UV1]](f32)
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0, implicit $vgpr1
...
define float @v_constained_fsub_f32_fpexcept_ignore_flags(float %x, float %y) #0 {
  ...
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(f32) = COPY $vgpr0
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(f32) = COPY $vgpr1
  ; CHECK-NEXT:   [[STRICT_FSUB:%[0-9]+]]:_(f32) = nsz nofpexcept G_STRICT_FSUB [[COPY]], [[COPY1]]
  ; CHECK-NEXT:   $vgpr0 = COPY [[STRICT_FSUB]](f32)
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
...
define float @v_constained_fmul_f32_fpexcept_ignore_flags(float %x, float %y) #0 {
  ...
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(f32) = COPY $vgpr0
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(f32) = COPY $vgpr1
  ; CHECK-NEXT:   [[STRICT_FMUL:%[0-9]+]]:_(f32) = nsz nofpexcept G_STRICT_FMUL [[COPY]], [[COPY1]]
  ; CHECK-NEXT:   $vgpr0 = COPY [[STRICT_FMUL]](f32)
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
...
define float @v_constained_fdiv_f32_fpexcept_ignore_flags(float %x, float %y) #0 {
  ...
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(f32) = COPY $vgpr0
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(f32) = COPY $vgpr1
  ; CHECK-NEXT:   [[STRICT_FDIV:%[0-9]+]]:_(f32) = nsz nofpexcept G_STRICT_FDIV [[COPY]], [[COPY1]]
  ; CHECK-NEXT:   $vgpr0 = COPY [[STRICT_FDIV]](f32)
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
...
define float @v_constained_frem_f32_fpexcept_ignore_flags(float %x, float %y) #0 {
  ...
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(f32) = COPY $vgpr0
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(f32) = COPY $vgpr1
  ; CHECK-NEXT:   [[STRICT_FREM:%[0-9]+]]:_(f32) = nsz nofpexcept G_STRICT_FREM [[COPY]], [[COPY1]]
  ; CHECK-NEXT:   $vgpr0 = COPY [[STRICT_FREM]](f32)
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
...
define float @v_constained_fma_f32_fpexcept_ignore_flags(float %x, float %y, float %z) #0 {
  ...
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(f32) = COPY $vgpr1
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:_(f32) = COPY $vgpr2
  ; CHECK-NEXT:   [[STRICT_FMA:%[0-9]+]]:_(f32) = nsz nofpexcept G_STRICT_FMA [[COPY]], [[COPY1]], [[COPY2]]
  ; CHECK-NEXT:   $vgpr0 = COPY [[STRICT_FMA]](f32)
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
...
define float @v_constained_sqrt_f32_fpexcept_strict(float %x) #0 {
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(f32) = COPY $vgpr0
  ; CHECK-NEXT:   [[STRICT_FSQRT:%[0-9]+]]:_(f32) = G_STRICT_FSQRT [[COPY]]
  ; CHECK-NEXT:   $vgpr0 = COPY [[STRICT_FSQRT]](f32)
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
