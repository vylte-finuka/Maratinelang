...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_orn2_i32_commute:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_or_not1_b32 s0, s2, s3
; GFX11-NEXT:    ; return to shader part epilog
  %not.src1 = xor i32 %src1, -1
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_orn2_i32_multi_use:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_or_not1_b32 s0, s2, s3
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_orn2_i32_multi_foldable_use:
; GFX11:       ; %bb.0:
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_orn2_i64:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_or_not1_b64 s[0:1], s[2:3], s[4:5]
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_orn2_i64_commute:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_or_not1_b64 s[0:1], s[2:3], s[4:5]
; GFX11-NEXT:    ; return to shader part epilog
  %not.src1 = xor i64 %src1, -1
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_orn2_i64_multi_foldable_use:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_or_not1_b64 s[0:1], s[2:3], s[6:7]
; GFX11-NEXT:    s_or_not1_b64 s[2:3], s[4:5], s[6:7]
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_orn2_i64_multi_use:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_or_not1_b64 s[0:1], s[2:3], s[4:5]
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_orn2_v2i32_commute:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_or_not1_b64 s[0:1], s[2:3], s[4:5]
; GFX11-NEXT:    ; return to shader part epilog
  %not.src1 = xor <2 x i32> %src1, <i32 -1, i32 -1>
...
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v0, s2, v0
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_orn2_v2i16_commute:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_or_not1_b32 s0, s2, s3
; GFX11-NEXT:    ; return to shader part epilog
  %not.src1 = xor <2 x i16> %src1, <i16 -1, i16 -1>
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_orn2_v2i16_multi_use:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_or_not1_b32 s0, s2, s3
; GFX11-NEXT:    s_xor_b32 s1, s3, -1
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_orn2_v2i16_multi_foldable_use:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_or_not1_b32 s0, s2, s4
; GFX11-NEXT:    s_or_not1_b32 s1, s3, s4
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX6-NEXT:    s_or_b32 s4, s4, s7
; GFX6-NEXT:    s_and_b32 s5, s5, 0xffff
; GFX6-NEXT:    s_xor_b64 s[2:3], s[4:5], s[2:3]
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: s_orn2_v4i16:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    s_mov_b32 s0, -1
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: s_orn2_v4i16_commute:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    s_mov_b32 s0, -1
; GFX10PLUS-NEXT:    s_mov_b32 s1, s0
; GFX10PLUS-NEXT:    s_xor_b64 s[0:1], s[4:5], s[0:1]
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: s_orn2_v4i16_multi_use:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    s_mov_b32 s0, -1
; GFX10PLUS-NEXT:    s_mov_b32 s1, s0
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: s_orn2_v4i16_multi_foldable_use:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    s_mov_b32 s0, -1
; GFX10PLUS-NEXT:    s_mov_b32 s1, s0
; GFX10PLUS-NEXT:    s_xor_b64 s[6:7], s[6:7], s[0:1]
; GFX10PLUS-NEXT:    s_or_b64 s[0:1], s[2:3], s[6:7]
; GFX10PLUS-NEXT:    s_or_b64 s[2:3], s[4:5], s[6:7]
; GFX10PLUS-NEXT:    ; return to shader part epilog
