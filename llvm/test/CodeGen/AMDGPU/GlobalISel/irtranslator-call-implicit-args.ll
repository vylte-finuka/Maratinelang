...
define amdgpu_kernel void @test_call_external_void_func_i32([17 x i8]) #0 {
  ...
  ; GFX900-NEXT:   [[SHL:%[0-9]+]]:_(i32) = G_SHL [[COPY18]], [[C2]](s32)
  ...
  ; GFX900-NEXT:   [[SHL1:%[0-9]+]]:_(i32) = G_SHL [[COPY19]], [[C3]](s32)
  ...
  ; GFX908-NEXT:   [[SHL:%[0-9]+]]:_(i32) = G_SHL [[COPY18]], [[C2]](s32)
  ...
  ; GFX908-NEXT:   [[SHL1:%[0-9]+]]:_(i32) = G_SHL [[COPY19]], [[C3]](s32)
...
define amdgpu_kernel void @test_call_external_void_func_v32i32([17 x i8]) #0 {
  ...
  ; GFX900-NEXT:   $vgpr2 = COPY [[UV2]](i32)
  ; GFX900-NEXT:   $vgpr3 = COPY [[UV3]](i32)
  ; GFX900-NEXT:   $vgpr4 = COPY [[UV4]](i32)
  ; GFX900-NEXT:   $vgpr5 = COPY [[UV5]](i32)
  ; GFX900-NEXT:   $vgpr6 = COPY [[UV6]](i32)
  ; GFX900-NEXT:   $vgpr7 = COPY [[UV7]](i32)
  ; GFX900-NEXT:   $vgpr8 = COPY [[UV8]](i32)
  ; GFX900-NEXT:   $vgpr9 = COPY [[UV9]](i32)
  ; GFX900-NEXT:   $vgpr10 = COPY [[UV10]](i32)
  ; GFX900-NEXT:   $vgpr11 = COPY [[UV11]](i32)
  ; GFX900-NEXT:   $vgpr12 = COPY [[UV12]](i32)
  ; GFX900-NEXT:   $vgpr13 = COPY [[UV13]](i32)
  ; GFX900-NEXT:   $vgpr14 = COPY [[UV14]](i32)
  ; GFX900-NEXT:   $vgpr15 = COPY [[UV15]](i32)
  ; GFX900-NEXT:   $vgpr16 = COPY [[UV16]](i32)
  ; GFX900-NEXT:   $vgpr17 = COPY [[UV17]](i32)
  ; GFX900-NEXT:   $vgpr18 = COPY [[UV18]](i32)
  ; GFX900-NEXT:   $vgpr19 = COPY [[UV19]](i32)
  ; GFX900-NEXT:   $vgpr20 = COPY [[UV20]](i32)
  ; GFX900-NEXT:   $vgpr21 = COPY [[UV21]](i32)
  ; GFX900-NEXT:   $vgpr22 = COPY [[UV22]](i32)
  ; GFX900-NEXT:   $vgpr23 = COPY [[UV23]](i32)
  ; GFX900-NEXT:   $vgpr24 = COPY [[UV24]](i32)
  ; GFX900-NEXT:   $vgpr25 = COPY [[UV25]](i32)
  ; GFX900-NEXT:   $vgpr26 = COPY [[UV26]](i32)
  ; GFX900-NEXT:   $vgpr27 = COPY [[UV27]](i32)
  ...
  ; GFX908-NEXT:   $vgpr2 = COPY [[UV2]](i32)
  ; GFX908-NEXT:   $vgpr3 = COPY [[UV3]](i32)
  ; GFX908-NEXT:   $vgpr4 = COPY [[UV4]](i32)
  ; GFX908-NEXT:   $vgpr5 = COPY [[UV5]](i32)
  ; GFX908-NEXT:   $vgpr6 = COPY [[UV6]](i32)
  ; GFX908-NEXT:   $vgpr7 = COPY [[UV7]](i32)
  ; GFX908-NEXT:   $vgpr8 = COPY [[UV8]](i32)
  ; GFX908-NEXT:   $vgpr9 = COPY [[UV9]](i32)
  ; GFX908-NEXT:   $vgpr10 = COPY [[UV10]](i32)
  ; GFX908-NEXT:   $vgpr11 = COPY [[UV11]](i32)
  ; GFX908-NEXT:   $vgpr12 = COPY [[UV12]](i32)
  ; GFX908-NEXT:   $vgpr13 = COPY [[UV13]](i32)
  ; GFX908-NEXT:   $vgpr14 = COPY [[UV14]](i32)
  ; GFX908-NEXT:   $vgpr15 = COPY [[UV15]](i32)
  ; GFX908-NEXT:   $vgpr16 = COPY [[UV16]](i32)
  ; GFX908-NEXT:   $vgpr17 = COPY [[UV17]](i32)
  ; GFX908-NEXT:   $vgpr18 = COPY [[UV18]](i32)
  ; GFX908-NEXT:   $vgpr19 = COPY [[UV19]](i32)
  ; GFX908-NEXT:   $vgpr20 = COPY [[UV20]](i32)
  ; GFX908-NEXT:   $vgpr21 = COPY [[UV21]](i32)
  ; GFX908-NEXT:   $vgpr22 = COPY [[UV22]](i32)
  ; GFX908-NEXT:   $vgpr23 = COPY [[UV23]](i32)
  ; GFX908-NEXT:   $vgpr24 = COPY [[UV24]](i32)
  ; GFX908-NEXT:   $vgpr25 = COPY [[UV25]](i32)
  ; GFX908-NEXT:   $vgpr26 = COPY [[UV26]](i32)
  ; GFX908-NEXT:   $vgpr27 = COPY [[UV27]](i32)
...
define amdgpu_kernel void @test_only_workitem_id_y() #0 !reqd_work_group_size !1 {
  ...
  ; GFX900-NEXT:   [[SHL:%[0-9]+]]:_(i32) = G_SHL [[COPY15]], [[C3]](s32)
  ...
  ; GFX908-NEXT:   [[SHL:%[0-9]+]]:_(i32) = G_SHL [[COPY15]], [[C3]](s32)
...
define amdgpu_kernel void @test_only_workitem_id_xy() #0 !reqd_work_group_size !3 {
  ...
  ; GFX900-NEXT:   [[COPY17:%[0-9]+]]:_(s32) = COPY [[COPY]](s32)
  ; GFX900-NEXT:   [[C2:%[0-9]+]]:_(s32) = G_CONSTANT i32 10
  ; GFX900-NEXT:   [[SHL:%[0-9]+]]:_(i32) = G_SHL [[COPY17]], [[C2]](s32)
  ...
  ; GFX908-NEXT:   [[COPY17:%[0-9]+]]:_(s32) = COPY [[COPY]](s32)
  ; GFX908-NEXT:   [[C2:%[0-9]+]]:_(s32) = G_CONSTANT i32 10
  ; GFX908-NEXT:   [[SHL:%[0-9]+]]:_(i32) = G_SHL [[COPY17]], [[C2]](s32)
...
define amdgpu_kernel void @test_only_workitem_id_yz() #0 !reqd_work_group_size !4 {
  ...
  ; GFX900-NEXT:   [[COPY16:%[0-9]+]]:_(s32) = COPY [[COPY1]](s32)
  ; GFX900-NEXT:   [[C3:%[0-9]+]]:_(s32) = G_CONSTANT i32 10
  ; GFX900-NEXT:   [[SHL:%[0-9]+]]:_(i32) = G_SHL [[COPY16]], [[C3]](s32)
  ; GFX900-NEXT:   [[OR:%[0-9]+]]:_(i32) = G_OR [[C2]], [[SHL]]
  ; GFX900-NEXT:   [[COPY17:%[0-9]+]]:_(s32) = COPY [[COPY]](s32)
  ; GFX900-NEXT:   [[C4:%[0-9]+]]:_(s32) = G_CONSTANT i32 20
  ; GFX900-NEXT:   [[SHL1:%[0-9]+]]:_(i32) = G_SHL [[COPY17]], [[C4]](s32)
  ; GFX900-NEXT:   [[OR1:%[0-9]+]]:_(i32) = G_OR [[OR]], [[SHL1]]
  ; GFX900-NEXT:   $vgpr0 = COPY [[C]](i32)
  ; GFX900-NEXT:   [[COPY18:%[0-9]+]]:_(<4 x s32>) = COPY $private_rsrc_reg
  ; GFX900-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = COPY [[COPY18]](<4 x s32>)
  ...
  ; GFX908-NEXT:   [[COPY16:%[0-9]+]]:_(s32) = COPY [[COPY1]](s32)
  ; GFX908-NEXT:   [[C3:%[0-9]+]]:_(s32) = G_CONSTANT i32 10
  ; GFX908-NEXT:   [[SHL:%[0-9]+]]:_(i32) = G_SHL [[COPY16]], [[C3]](s32)
  ; GFX908-NEXT:   [[OR:%[0-9]+]]:_(i32) = G_OR [[C2]], [[SHL]]
  ; GFX908-NEXT:   [[COPY17:%[0-9]+]]:_(s32) = COPY [[COPY]](s32)
  ; GFX908-NEXT:   [[C4:%[0-9]+]]:_(s32) = G_CONSTANT i32 20
  ; GFX908-NEXT:   [[SHL1:%[0-9]+]]:_(i32) = G_SHL [[COPY17]], [[C4]](s32)
  ; GFX908-NEXT:   [[OR1:%[0-9]+]]:_(i32) = G_OR [[OR]], [[SHL1]]
  ; GFX908-NEXT:   $vgpr0 = COPY [[C]](i32)
  ; GFX908-NEXT:   [[COPY18:%[0-9]+]]:_(<4 x s32>) = COPY $private_rsrc_reg
  ; GFX908-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = COPY [[COPY18]](<4 x s32>)
